          ...
          <div className={styles.DashboardLeftCol}>
            <section className={styles.DashboardPortfolioCard}>
              <div className={styles.DashboardPortfolioTop}>
                <div className={styles.DashboardBalanceInfo}>
                  ...
                  <h2 className={styles.DashboardMainBalance}>
                    {loadingDashboard ? (
                      <LoadingDots />
                    ) : (
            ...
            <div className={styles.DashboardPromoBanner}>
              <div className={styles.DashboardPromoContent}>
                ...
                <h3 className={styles.DashboardPromoTitle}>
                  Build your gold nest egg
                </h3>
                <p className={styles.DashboardPromoText}>
                  Start saving in 24K Pure Gold from just ₹10.
                </p>
                <button
                  className={styles.DashboardPromoAction}
                  onClick={() => navigate("/digitalGold")}
                >
                  Get Started
                </button>
              </div>
            ...
            <div className={styles.DashboardSectionHeader}>
              <h4 className={styles.DashboardSectionTitle}>
                Investment Products
              </h4>
            </div>
            <div className={styles.DashboardProductGrid}>
              {products.map((item, idx) => (
                <div
                  key={idx}
                  className={`${styles.DashboardProductItem} ${item.status === "coming" ? styles.DashboardProductSoon : ""}`}
                  onClick={() => navigate(item.link)}
                >
                  {item.status === "coming" && (
                    <span className={styles.DashboardMiniBadge}>Soon</span>
                  )}
                  <div
                    className={styles.DashboardIconBox}
                  ...
                  <ChevronRight
                    size={14}
                    className={styles.DashboardArrowIcon}
                  />
                </div>
              ))}
            </div>
          ...
          <div className={styles.DashboardRightCol}>
            ...
            <div className={styles.DashboardDistributionCard}>
              <div className={styles.DashboardDistRow}>
                <span
                  className={styles.DashboardDistDot}
                  style={{ background: "#FFD700" }}
                ></span>
                <p>Digital Gold</p>
                <span className={styles.DashboardDistPercent}>
                  {loadingDashboard ? <LoadingDots /> : assetDist?.digitalGold}%
                </span>
              </div>
              <div className={styles.DashboardDistRow}>
                <span
                ...
                <p>Fixed Deposit</p>
                <span className={styles.DashboardDistPercent}>
                  {loadingDashboard ? <LoadingDots /> : assetDist?.fd}%
                </span>
              </div>
              <div className={styles.DashboardDistRow}>
                <span
                  className={styles.DashboardDistDot}
                  style={{ background: "#058e0f" }}
                ></span>
                <p>Mutual Fund</p>
                <span className={styles.DashboardDistPercent}>
                  {loadingDashboard ? <LoadingDots /> : assetDist?.mutualFund}%
                </span>
              </div>
            </div>
            ...
            <div className={styles.DashboardToolList}>
              <div className={styles.DashboardToolCard}>
                <div className={styles.DashboardToolIcon}>
                  <Calculator size={16} />
                </div>
